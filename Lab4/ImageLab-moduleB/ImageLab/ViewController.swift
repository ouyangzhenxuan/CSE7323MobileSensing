...
//        chtChart.leftAxis.axisMinimum = 30
//        chtChart.leftAxis.axisMaximum = 50
//        chtChart.setVisibleXRange(minXRange: Double(self.bgrData.count-10), maxXRange: Double(self.bgrData.count))
//        chtChart.setVisibleXRange(minXRange: 3.0, maxXRange: 3.0)
